#ifndef cciStaticModuleLoader_h
#define cciStaticModuleLoader_h
/* ***** BEGIN LICENSE BLOCK *****
...
class cciStaticModuleLoader : public cciIModuleLoader
{
 ...
 protected:
    cciStaticModuleEntry* FindModuleEntry(const dmCString& aLocation);

    dmHashPtrDict mModules;
};


#endif // cciStaticModuleLoader_h
