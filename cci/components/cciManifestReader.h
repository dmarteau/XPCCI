...
#ifndef cciManifestLineReader_h
#define cciManifestLineReader_h

class cciManifestLineReader
{
public:
     cciManifestLineReader() : mBase(dm_null) {}
    ~cciManifestLineReader() {}

    void Init(char* base, dm_uint32 flen)
    {
    ...
    {
        CCI_ASSERTION(mCur && maxChunks && chunks, "bad call to ParseLine");
        int found = 0;
        chunks[found++] = mCur;
